...
model_param m_p = read_model("/sdcard/gesture_data/model_5.txt");
forward_param f_p(layer, 1);

JNIEXPORT void

JNICALL
Java_com_enterprise_bulletcross_deepsea_1test_inference_predictor_loadweight(
        JNIEnv *env,
        jobject ) {
...
JNICALL
Java_com_enterprise_bulletcross_deepsea_1test_inference_predictor_predictJNI(
        JNIEnv *env,
        jobject ,
        jdoubleArray inp) {
